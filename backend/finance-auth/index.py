...
def handler(event: dict, context) -> dict:
    """Проверка логина и пароля для входа в раздел финансовой статистики."""
    cors = {
    ...
    correct_login = os.environ.get('FINANCE_ADMIN_LOGIN', '')
    correct_password = os.environ.get('FINANCE_ADMIN_PASSWORD', '')

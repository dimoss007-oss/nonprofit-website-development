...
const FILES_API = "https://functions.poehali.dev/8353edab-4af8-435b-8e9b-acb557f8bd89";
...
function TaskFilesSection({ taskId, uploaderLogin }: { taskId: number; uploaderLogin: string }) {
...
function TaskCard({ task, onStatusChange, onEdit, onDelete, isAdmin, currentLogin }: {
  task: Task;
